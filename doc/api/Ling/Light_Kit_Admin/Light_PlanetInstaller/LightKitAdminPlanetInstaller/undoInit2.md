...
LightKitAdminPlanetInstaller::undoInit2
================



LightKitAdminPlanetInstaller::undoInit2 — Undoes the init 2 phase.
...
Source Code
===========
See the source code for method [LightKitAdminPlanetInstaller::undoInit2](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/Light_PlanetInstaller/LightKitAdminPlanetInstaller.php#L95-L142)
...
Previous method: [init2](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/doc/api/Ling/Light_Kit_Admin/Light_PlanetInstaller/LightKitAdminPlanetInstaller/init2.md)<br>Next method: [init3](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/doc/api/Ling/Light_Kit_Admin/Light_PlanetInstaller/LightKitAdminPlanetInstaller/init3.md)<br>
