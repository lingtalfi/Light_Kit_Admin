...
LightKitAdminController::getKitPageRendererInstance
================



LightKitAdminController::getKitPageRendererInstance — Returns the LightKitPageRenderer instance to use to render the pages.
...
Source Code
===========
See the source code for method [LightKitAdminController::getKitPageRendererInstance](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/Controller/LightKitAdminController.php#L291-L329)
...
Previous method: [error](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/doc/api/Ling/Light_Kit_Admin/Controller/LightKitAdminController/error.md)<br>
