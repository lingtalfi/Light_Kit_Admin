...
LightKitAdminController::alcpResponse
================



LightKitAdminController::alcpResponse — Returns a response using the Ling.Light_AjaxHandler handler under the hood.
...
Source Code
===========
See the source code for method [LightKitAdminController::alcpResponse](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/Controller/LightKitAdminController.php#L197-L205)
...
Previous method: [getRedirectResponseByRoute](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/doc/api/Ling/Light_Kit_Admin/Controller/LightKitAdminController/getRedirectResponseByRoute.md)<br>Next method: [checkRight](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/doc/api/Ling/Light_Kit_Admin/Controller/LightKitAdminController/checkRight.md)<br>
