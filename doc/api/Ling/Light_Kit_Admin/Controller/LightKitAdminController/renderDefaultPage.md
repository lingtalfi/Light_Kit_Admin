...
LightKitAdminController::renderDefaultPage
================



LightKitAdminController::renderDefaultPage — Renders the default page, and returns the corresponding http response.
...
Source Code
===========
See the source code for method [LightKitAdminController::renderDefaultPage](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/Controller/LightKitAdminController.php#L171-L175)
