...
- Methods
    - public [render](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/doc/api/Ling/Light_Kit_Admin/Controller/LogoutController/render.md)() : string | [HttpResponseInterface](https://github.com/lingtalfi/Light/blob/master/doc/api/Ling/Light/Http/HttpResponseInterface.md)
...
Location
=============
Ling\Light_Kit_Admin\Controller\LogoutController<br>
See the source code of [Ling\Light_Kit_Admin\Controller\LogoutController](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/Controller/LogoutController.php)



SeeAlso
==============
Previous class: [LoginFormController](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/doc/api/Ling/Light_Kit_Admin/Controller/LoginFormController.md)<br>Next class: [RealAdminPageController](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/doc/api/Ling/Light_Kit_Admin/Controller/RealAdminPageController.md)<br>
