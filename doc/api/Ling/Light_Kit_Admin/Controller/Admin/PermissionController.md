...
- Methods
    - public [render](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/doc/api/Ling/Light_Kit_Admin/Controller/Admin/PermissionController/render.md)() : string | [HttpResponseInterface](https://github.com/lingtalfi/Light/blob/master/doc/api/Ling/Light/Http/HttpResponseInterface.md)
...
Location
=============
Ling\Light_Kit_Admin\Controller\Admin\PermissionController<br>
See the source code of [Ling\Light_Kit_Admin\Controller\Admin\PermissionController](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/Controller/Admin/PermissionController.php)



SeeAlso
==============
Previous class: [LightKitAdminTableListConfigurationHandler](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/doc/api/Ling/Light_Kit_Admin/ChloroformExtension/LightKitAdminTableListConfigurationHandler.md)<br>Next class: [AdminPageController](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/doc/api/Ling/Light_Kit_Admin/Controller/AdminPageController.md)<br>
