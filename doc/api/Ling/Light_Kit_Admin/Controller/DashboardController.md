...
- Methods
    - public [render](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/doc/api/Ling/Light_Kit_Admin/Controller/DashboardController/render.md)() : string | [HttpResponseInterface](https://github.com/lingtalfi/Light/blob/master/doc/api/Ling/Light/Http/HttpResponseInterface.md)
...
Location
=============
Ling\Light_Kit_Admin\Controller\DashboardController<br>
See the source code of [Ling\Light_Kit_Admin\Controller\DashboardController](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/Controller/DashboardController.php)



SeeAlso
==============
Previous class: [AdminPageController](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/doc/api/Ling/Light_Kit_Admin/Controller/AdminPageController.md)<br>Next class: [ForbiddenController](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/doc/api/Ling/Light_Kit_Admin/Controller/ForbiddenController.md)<br>
