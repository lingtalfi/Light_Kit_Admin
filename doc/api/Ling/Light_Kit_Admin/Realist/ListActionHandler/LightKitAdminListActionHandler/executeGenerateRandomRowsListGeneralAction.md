...
LightKitAdminListActionHandler::executeGenerateRandomRowsListGeneralAction
================



LightKitAdminListActionHandler::executeGenerateRandomRowsListGeneralAction — Executes the generate random rows list general action and returns the result.
...
Source Code
===========
See the source code for method [LightKitAdminListActionHandler::executeGenerateRandomRowsListGeneralAction](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/Realist/ListActionHandler/LightKitAdminListActionHandler.php#L501-L552)
...
Previous method: [executePrintListAction](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/doc/api/Ling/Light_Kit_Admin/Realist/ListActionHandler/LightKitAdminListActionHandler/executePrintListAction.md)<br>Next method: [executeSaveTableListGeneralAction](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/doc/api/Ling/Light_Kit_Admin/Realist/ListActionHandler/LightKitAdminListActionHandler/executeSaveTableListGeneralAction.md)<br>
