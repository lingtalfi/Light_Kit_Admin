...
Source Code
===========
See the source code for method [LightKitAdminService::addNotification](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/Service/LightKitAdminService.php#L197-L200)
