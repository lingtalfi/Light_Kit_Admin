...
Source Code
===========
See the source code for method [LightKitAdminService::setOptions](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/Service/LightKitAdminService.php#L127-L130)
