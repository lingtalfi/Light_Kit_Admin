...
Source Code
===========
See the source code for method [LightKitAdminService::install](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/Service/LightKitAdminService.php#L282-L417)
